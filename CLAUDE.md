...
**Какво работи:** Логин, dashboard, всички секции (ваксини, спомени, растеж и т.н.), качване на снимки в Google Drive.

**Ако нещо се счупи — как да върнем:**
```
git checkout claude/read-claude-docs-gHaua
git checkout a637a4f -- index.html
git commit -m "Връща работещата версия"
git push
```

**Известен проблем (НЕ критичен):** Качените снимки се запазват в Drive, но не се показват в картите на спомените. Ще се оправи отделно.
